...
$yourEmail = "walker.albert@gmail.com";

$requiredFields = "last-name";

$defaultText = "Please submit your information below.";

$errorText = "TRY AGAIN! You didn't enter the required fields, silly!";

$successText = "YEAH! You submitted it and everything is super duper!";
